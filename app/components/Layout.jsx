          ...
          <div className="nav-item-group" style={{ display: 'flex', flexDirection: 'column', width: '100%' }}>
            ...
            {isProductsSubmenuOpen && (
              <div className="submenu" style={{ display: 'flex', flexDirection: 'column', gap: '0.15rem', paddingLeft: isCollapsed ? '0' : '2.25rem', marginTop: '0.15rem', overflow: 'hidden' }}>
                <Link to="/products/order" className="submenu-item" activeProps={{ className: 'submenu-item active' }} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.5rem 0.75rem', textDecoration: 'none', fontSize: '0.85rem', fontWeight: '500', borderRadius: 'var(--border-radius-md)', transition: 'var(--transition)' }}>
                  ...
                  <span className="submenu-text" style={{ display: isCollapsed ? 'none' : 'inline' }}>Order</span>
                </Link>
