...
import { Route as resetPasswordRoute } from '../app/routes/api/auth/reset-password.js';
...
const resetPasswordRouteUpdated = resetPasswordRoute.update({ id: '/api/auth/reset-password', path: '/api/auth/reset-password', getParentRoute: () => rootRoute });
